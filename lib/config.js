...
const JAMBONZ_CLEANUP_CALLS_INTERVAL_MINS = process.env.JAMBONZ_CLEANUP_CALLS_INTERVAL_MINS;
const getCleanupIntervalMins = () => {
  const interval = parseInt(JAMBONZ_CLEANUP_INTERVAL_MINS, 10) || 60;
  return 1000 * 60 * interval;
};
const getCallCleanupIntervalMins = () => {
  const interval = parseInt(JAMBONZ_CLEANUP_CALLS_INTERVAL_MINS, 10) || 15;
  return 1000 * 60 * interval;
};
